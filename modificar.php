<?php 
    ...
    $id = $_GET['id'];  //RETORNA ID DE LA BD SEGUN LA FILA SELECIONADA DE TABLA
	
	$sql = "SELECT * FROM personas WHERE id = '$id'"; //MOSTRAR LOS REGISTRO DE LA TABLA SEGUN ID MEDIANTE CONSULTA
		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
            	...
            	<div class="form-group">
				   ...
				   <div class="col-sm-10">
                          <!--AGREGAMOS EL VALUES PARA AGREGAR EL NOMBRE MODIFICADO-->
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
                         <!--AGREGAMOS EL VALUES PARA AGREGAR EL eMail MODIFICADO-->
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
                         <!--AGREGAMOS EL VALUES PARA AGREGAR EL telefono  MODIFICADO-->
						<input type="tel" class="form-control" id="telefono" name="telefono" placeholder="Telefono" value ="<?php echo $row['telefono'];?>">
					</div>
				</div>
				 <!--PARA MOFIFICAR EL ESTADO CIVIL SE USARA UN IF LA COMPARARÁ CON LAS 3 OPCIONES-->
				<div class="form-group">
					<label for="estado_civil" class="col-sm-2 control-label">Estado Civil</label>
					<div class="col-sm-10">
						<select class="form-control" id="estado_civil" name="estado_civil">
                            <!--COMPARCION DE LA BD Y LAS OPCIONES DEL SELECTOR--->
				...
				<!--REGISTRO DE INTERESE-->
				<div class="form-group">
					<label for="intereses" class="col-sm-2 control-label">INTERESES</label>
					
					<div class="col-sm-10">

                        <!--SE REALIZA UNA FUNCION PARA RECORRER LOS ARREGLOS-->
